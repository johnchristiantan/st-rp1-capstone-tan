        ...
        <>
            ...
            {jwt ? (
                <>
                    ...
                    <Route path="/booking" element={<NewTransaction setJwt={setJwt} />} />
                    <Route path="/branches" element={<Branches setJwt={setJwt} />} />
                    <Route path="/services" element={<Services setJwt={setJwt} />} />
                    <Route path="/discounts" element={<Discounts setJwt={setJwt} />} />
                    <Route path="/settings" element={<Settings setJwt={setJwt} />} />
                    <Route path="/users" element={<ShowUsers setJwt={setJwt} />} />
                    <Route path="/" element={<Redirect setJwt={setJwt} />} />
                    <Route path="/profile" element={<Redirect setJwt={setJwt} />} />
                </>
            ) : (
                <>
                    {/* <Route path="/" element={<Home />} /> */}
                    <Route path="/" element={<LoginForm setJwt={setJwt} />} />
